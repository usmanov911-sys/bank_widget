...
Проект предназначен для обработки финансовых транзакций. Он предоставляет инструменты для фильтрации, сортировки данных, маскирования банковских карт и счетов, а также для генерации тестовых наборов информации.
...
В проекте реализован универсальный декоратор @log в модуле src/decorators.py, содержащий логику автоматического логирования работы функций.
